...
namespace SoccerPlayer.DataAcess.Controllers
{
    ...
    public class PlayerController : Controller
    {
        ...
        public int CreatePlayer(string FirstName, string LastName, string Age, string Team, string Position)
        {
        ...
        public int UpdatePlayer(int PlayerID, string FirstName, string LastName, string Age, string Team, string Position)
        {
